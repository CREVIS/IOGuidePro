...
| 20180829 | 1.0.0.0 SIXNET_beta3 | [Download](https://github.com/CREVIS/IOGuidePro/raw/master/SIXNET/IOGuidePro(1.0.0.0)_3_SIXNET.zip)|<ul><li>설치파일에서, docuFnIO 제작자명 sixnet으로 변경 / <span style="color:red;">속성에 언어 한국어로 표시 –>영어로 변경(불가)</span></li><li>Project Domumentation PDF 파일 이름 변경</li><li> modbusDRV.dll 속성 copyright 이름 변경</li></ul> | 
